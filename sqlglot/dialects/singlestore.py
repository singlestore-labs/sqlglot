...
def _build_field(args: [exp.Expression]):
    if len(args) < 2:
        return None
    ...
    class Parser(parser.Parser):
        ...
        FUNCTIONS = {
            **parser.Parser.FUNCTIONS,
            ...
            "EUCLIDEAN_DISTANCE": lambda args: exp.Distance(this=seq_get(args, 0), expression=seq_get(args, 1)),
            ...
            "HOUR": lambda args: exp.Add(
                ...
                expression=exp.Literal.number(1)),
            "GET_FORMAT": lambda args: exp.func("GET_FORMAT", _column_to_var(seq_get(args, 0)), seq_get(args, 1)),
